!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!     File hs76Max.f    Example program for SQOPT
!
!     Various examples related to problem  Hock-Schittkowski 76.
!
!     Sample program for SQOPT Version 2.1-0   Sep 2015.
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
!     ------------------------------------------------------------------
!     1. Maximize hs76, a QP with an explicit linear objective.
!     ------------------------------------------------------------------
      write(nOut, *) ' '
      write(nOut, *) ' '
      write(nOut, *) '------------------------'
      write(nOut, *) ' 1. Solve the QP hs76Max'
      write(nOut, *) '------------------------'
...
!     ------------------------------------------------------------------
!     2. Maximize hs76 in elastic mode.
!     ------------------------------------------------------------------
      write(nOut, *) ' '
      write(nOut, *) '--------------------------------------------'
      write(nOut, *) ' 2. hs76 (maximize) starting in elastic mode'
      write(nOut, *) '--------------------------------------------'
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'hs76Max ( in elatic mode) finished. '
      write(nOut, *) 'Input errors   =', Errors
      write(nOut, *) 'hs76   INFO    =', INFO
      write(nOut, *) 'nInf           =', nInf
      write(nOut, *) 'sInf           =', sInf
...
!     ------------------------------------------------------------------
!     3. Solve hs76Max with the quasi-Newton solver.
!     ------------------------------------------------------------------
      write(nOut, *) ' '
      write(nOut, *) ' '
      write(nOut, *) '----------------------------------------------'
      write(nOut, *) ' 3. Solve hs76Max with the quasi-Newton solver'
      write(nOut, *) '----------------------------------------------'
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'hs76Max (with QN option) finished.  '
      write(nOut, *) 'Input errors   =', Errors
      write(nOut, *) 'hs76   INFO    =', INFO
      write(nOut, *) 'nInf           =', nInf
      write(nOut, *) 'sInf           =', sInf
...
!     ------------------------------------------------------------------
!     4. Solve hs76Max with the quasi-Newton solver.
!     ------------------------------------------------------------------
      write(nOut, *) ' '
      write(nOut, *) ' '
      write(nOut, *) '------------------------------------'
      write(nOut, *) ' 4. Solve hs76Max with the QN solver'
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'hs76Max (QN, elastic start) finished.  '
      write(nOut, *) 'Input errors   =', Errors
      write(nOut, *) 'hs76   INFO    =', INFO
      write(nOut, *) 'nInf           =', nInf
      write(nOut, *) 'sInf           =', sInf
...
!     ==================================================================
!     hs76MaxData   defines the problem HS76.
!
!     (1) Compute l, u, and A so that the constraints are ranges of the
!         form  l <= Ax <= u.
!         Store l and u in bl(n+1:n+m) and bu(n+1:n+m).
...
!     ------------------------------------------------------------------
      ...
      end ! subroutine hs76MaxData

!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

      subroutine hs76MaxEData
     &   ( maxm, maxn, maxne,
     &     m, n, ne, nNames, lencObj, ncolH,
     &     iObjA, objAdd, ProblemName,
     &     Acol, indA, locA, bl, bu, cObj,
...
!     ==================================================================
!     hs76MaxEData   defines the problem HS76.
!
!     (1) Compute l, u, and A so that the constraints are ranges of the
!         form  l <= Ax <= u.
!         Store l and u in bl(n+1:n+m) and bu(n+1:n+m).
...
!     ==================================================================
!     This is the user-defined Hessian-vector product for hs76Max.
!     ==================================================================
      integer
     &     i, j
      double precision
...
!     ------------
 ...
 1000 format(/ ' This is  hs76Max.   ncolH =', i4)
 2000 format(/ ' Finished hs76Max.')
