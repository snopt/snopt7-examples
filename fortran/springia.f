...
!     nOut    is an output file used here by sntest.
      ...
      iSpecs =  4  ! equivalenced to springia.spc
      iPrint =  9  ! equivalenced to springia.out
...
!     ------------------------------------------------------------------
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'springia (f) finished.'
...
!     ------------------------------------------------------------------
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'springia (fg) finished.'
      write(nOut, *) 'Input errors  =', Errors
...
!     ==================================================================
!     springData0  generates data for the test problem springia
!     The objective and constraint function Derivative are not computed.
!
!     On entry,
...
!     Write T into the problem name.
      ...
      write(nOut, *) 'Problem springia.   T =', T
...
!     state   variables y:     1: T+1   (T+1 y-variables)
!     state   variables x:   T+2:2T+2   (T+1 x-variables
!     control variables u:  2T+3:3T+2   (T   u-variables)
...
!        Initialize the bounds and values of the controls u.
...
!     Added 13/10/14 to make springia infeasible

      xlow(ju0) = -10.0d0  ! u(0) = -10
      xupp(ju0) = -10.0d0

!     Fix the boundary conditions.
!     y states:   y(0) = 0, y(T)  =  0,
...
!     ==================================================================
!     This is userf for problem springia.
!
!     ==================================================================
      double precision
...
!     ==================================================================
!     springData1  generates data for the test problem springia
!
!     On entry,
!     maxF, maxn are upper limits on nF and n.
!
...
!     ==================================================================
!     This is userfg for problem springia.
!
!     ==================================================================
      double precision
     &     FObj, xt, yt
...
!     The variables are ordered as follows:
!     state   variables x:     1: T+1
!     state   variables y:   T+2:2T+2
!     control variables u:  2T+2:3T+2
!     jx, jy, ju are the base indices for the corresponding variables
