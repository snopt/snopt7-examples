!     ------------------------------------------------------------------
!     File hs47Moda.f : solves a modified version of hs47.
!     The modification involves:
!     (1) two two general  linear constraints
!     (2) a finite lower bound on x(1).
!
!     The solution is identical to the solution of hs47a.f.
!
...
!     ------------------------------------------------------------------
!     1. Solve a modified version of hs47.
!     ------------------------------------------------------------------
      write(nOut, *) ' '
      write(nOut, *) ' '
      write(nOut, *) '------------------------------'
      write(nOut, *) '1. Modified version of hs47   '
...
!     ------------------------------------------------------------------
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'hs47Moda (f only) finished.'
...
!     ------------------------------------------------------------------
      ...
      write(nOut, *) ' '
      write(nOut, *) '------------------------------'
      write(nOut, *) '2. Modified version of hs47   '
...
!     ------------------------------------------------------------------
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'hs47Moda (f and g) finished.'
      write(nOut, *) 'Input errors  =', Errors
      write(nOut, *) 'INFO          =', INFO
      write(nOut, *) 'nInf          =', nInf
      write(nOut, *) 'sInf          =', sInf
