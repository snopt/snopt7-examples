!     ------------------------------------------------------------------
!     File hs47ModInfc.f : solves a modified version of hs47.
...
!        Unix and DOS systems.  Open the Specs and print files.
         ...
         lfile = 'hs47ModInfc.spc'
         open( iSpecs, file=lfile, status='OLD',     err=800 )

         lfile = 'hs47ModInfc.out'
...
!     ------------------------------------------------------------------
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'hs47ModInfc finished.'
...
!     ------------------------------------------------------------------
!     userfun is userfun for interface snoptC.
!
!     mode
!     ----
!      0  fObj, fCon
!      1  known elements of gObj, gCon
!      2  fObj, fCon and known elements of gObj and gCon.
!
!     Derivative level
!      0
!      1
...
!     ---------------------------------------------------------
!     No nonlinear constraint elements for column 5 (g=df/dx4).
!      --------------------------------------------------------
      if (NeedG) then
