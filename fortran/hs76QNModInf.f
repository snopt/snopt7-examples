!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!     File hs76QNModInf.f    Example program for SQOPT
!
...
*        Unix and DOS systems.  Open the Specs and print files.
         ...
         lfile = 'hs76QNModInf.spc'
         open( iSpecs, file=lfile, status='OLD',     err=800 )

         lfile = 'hs76QNModInf.out'
...
!     ------------------------------------------------------------------
      ...
      write(nOut, *) ' '
      write(nOut, *) '-------------------------------------------------'
      write(nOut, *) ' 1. hs76QNModInf: hs76 with infeas. constraints  '
...
!     ------------------------------------------------------------------
      ...
      write(nOut, *) ' '
      write(nOut, *) '-------------------------------------------------'
      write(nOut, *) ' 2. hs76QNModInf: hs76 with infeas constraints.  '
...
!     Elastic mode      = 1 => enter elastic mode only if infeasible.
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'hs76QNModInf (Ex) finished.'
      write(nOut, *) 'Input errors   =', Errors
      write(nOut, *) 'sqopt INFO     =', INFO
      write(nOut, *) 'nInf           =', nInf
      write(nOut, *) 'sInf           =', sInf
...
!     ------------------------------------------------------------------
      write(nOut, *) ' '
      write(nOut, *) '-------------------------------------------------'
      write(nOut, *) ' 3. hs76QNModInf: hs76 with infeas constraints.  '
...
!     No need for elastic mode. The problem is always feasible.
     ...
     &     cw, lencw, iw, leniw, rw, lenrw )
      ...
      write(nOut, *) ' '
      write(nOut, *) 'hs76QNModInf (Ex2) finished.'
      write(nOut, *) 'Input errors   =', Errors
      write(nOut, *) 'sqopt INFO     =', INFO
      write(nOut, *) 'nInf           =', nInf
      write(nOut, *) 'sInf           =', sInf
...
!     ------------
 ...
 1000 format(/ ' This is  hs76QNModInf.   ncolH =', i4)
 2000 format(/ ' Finished hs76QNModInf.')
